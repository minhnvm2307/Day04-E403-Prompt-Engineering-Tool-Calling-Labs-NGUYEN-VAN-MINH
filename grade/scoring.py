...
def main() -> int:
    ...
    parser.add_argument("--judge-provider", default="openai", choices=["google", "ollama", "openai"])
    parser.add_argument("--judge-model-name", default="cx/gpt-5.4", help="LLM model to use for grading, if LLM grading is enabled.")
